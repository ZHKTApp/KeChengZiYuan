...
public class FileUtils {
    ...
    public static String PROJECT_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "ys_download" + File.separator;
    ...
    //查看是否有该文件 是否删除
    public static boolean getFilesbolen(String filename, boolean isDelete,Context mContext) {
        File file = new File(PROJECT_PATH);
        File dirPath = new File(file, DeviceUtil.getPackageName(App.mContext));
